...
class EncounterBuilder:
    ...
    def build(self, node: MapNode, rng: Random) -> CombatSetup:
    ...
    def _build_boss(self) -> CombatSetup:
        from src.dungeon.enemies.bosses.boss_loader import load_boss_template
        from src.dungeon.enemies.bosses.boss_registry import register_all_bosses
        register_all_bosses()
        template = load_boss_template("goblin_king")
