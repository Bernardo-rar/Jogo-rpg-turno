...
class VictoryScene:
    """Tela de vitória com stats da run."""
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        draw_centered(surface, self._fonts.large, "VITORIA!", cx, 250, colors.TEXT_YELLOW)
        draw_centered(
        ...
        draw_centered(
            surface, self._fonts.medium,
            "O dungeon foi derrotado!",
            cx, 390, colors.TEXT_HEAL,
        )
        draw_centered(
            surface, self._fonts.small,
            "[ENTER] Menu Principal", cx, 470, colors.TEXT_MUTED,
        )
