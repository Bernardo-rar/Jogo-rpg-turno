...
class TreasureScene:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        draw_centered(surface, self._fonts.large, "Bau do Tesouro!", cx, 180, _GOLD_COLOR)
...
def _draw_gold(
    ...
    text = f"+{gold} Gold"
    draw_centered(surface, fonts.medium, text, cx, 260, colors.TEXT_YELLOW)
...
def _draw_drops(
    ...
    if not drops:
        return
    y = 320
    draw_centered(surface, fonts.medium, "Itens encontrados:", cx, y, colors.TEXT_WHITE)
